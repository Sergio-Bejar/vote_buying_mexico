...
The analytical distinction between supply-side and demand-side explanations for vote buying has a long lineage. \citet{bejar2010party} proposed a comprehensive framework that separated the supply side---how the institutional incentives generated by party system characteristics drive politicians' decisions to buy votes---from the demand side---how information environments and social norms shape voters' willingness to engage in clientelistic exchange. That framework emphasized institutional variation at the macro level, arguing that weakly institutionalized party systems generate electoral volatility, which in turn creates both supply-side incentives for politicians and demand-side conditions among voters that make vote buying more likely. We retain the supply/demand architecture but redirect it: rather than treating the demand side as a function of individual-level information deficits, we argue that it operates primarily through community-level norms that condition the returns to clientelistic investment across all parties simultaneously.
...
This perspective shifts the analytical focus from broker optimization over individuals to the spatial distribution of clientelistic receptivity. \citet{bejar2010party} documented that norms of reciprocity---drawing on \citet{scott1972patron}, \citet{lemarchand1972political}, and \citet{finan2012information}---sustain clientelistic exchange by creating mutual obligations between patrons and clients that reduce the enforcement costs of vote buying. That analysis treated reciprocity as a demand-side mechanism operating at the individual level, explaining why some voters accept material inducements while others do not. We build on this foundation but shift the level of analysis: rather than asking why individual voters engage in clientelistic transactions, we ask why certain communities sustain them across all parties. The norms of reciprocity, tolerance of material exchange, and expectations of campaign-season distribution that \citet{bejar2010party} identified as individual-level demand factors are, we argue, properties of places---socially transmitted, locally enforced, and geographically bounded. When these norms are strong, vote buying becomes a reliable strategy for \textit{any} party willing to invest; when they are absent, the same resources yield lower and more uncertain returns. Because these features are properties of the community rather than of any particular party, they generate common targeting incentives: even in the absence of coordination, competing parties converge on the same locations.
...
However, electoral volatility---the standard proxy for swing-voter targeting---shows no association with vote buying. PRI vote share volatility ($r = -0.063$), PAN volatility ($r = -0.049$), margin volatility ($r = -0.017$), and number of partisan alternations ($r = -0.065$) all yield null results. Earlier work, including \citet{bejar2010party}, hypothesized that electoral volatility should predict vote buying, drawing on the logic of party system institutionalization: weakly institutionalized systems generate unstable patterns of competition that create a market for votes. We test this prediction with precinct-level data spanning four municipal electoral cycles and find no support. The null is comprehensive---it holds across every operationalization of volatility and both electoral datasets---suggesting that the mechanism linking party system instability to clientelism operates, if at all, at a level of aggregation above the precinct. At the local level where brokers actually operate, vote buying appears to respond to community characteristics rather than to electoral uncertainty.
...
\bibitem[B\'{e}jar(2010)]{bejar2010party}
B\'{e}jar, S. (2010). \textit{Party systems, information flows, and vote buying in Latin America} (Doctoral dissertation). University of Notre Dame.
