...
However, electoral volatility---the standard proxy for swing-voter targeting---shows no association with vote buying. PRI vote share volatility ($r = -0.063$), PAN volatility ($r = -0.049$), margin volatility ($r = -0.017$), and number of partisan alternations ($r = -0.065$) all yield null results. This is inconsistent with models that predict clientelistic investment in electorally uncertain environments.
